...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="row row-cols-1 row-cols-md-3 g-4">
        ...
        %>--%>
        <asp:Repeater ID="repTarjetas" runat="server" OnItemDataBound="repTarjetas_ItemDataBound">
            <ItemTemplate>
                <div class="col">
                    <div class="card">
                                ...
                                <asp:Repeater ID="repImagenes" runat="server">
                                    <ItemTemplate>
                                        <div class='carousel-item <%# Container.ItemIndex == 0 ? "active" : "" %>'>
                                            <img src='<%# Eval("ImagenUrl") %>' alt="Imagen articulo" />
                                        </div>
                                    </ItemTemplate>
                                </asp:Repeater>
                            </div>
                        ...
                        <div class="card-body">
                            ...
                            <asp:Button Text="Seleccionar" CssClass="btn btn-primary" runat="server"
                                ID="btnElegirPremio" OnClick="btnElegirPremio_Click" />
                        </div>
                    </div>
                </div>
            </ItemTemplate>
